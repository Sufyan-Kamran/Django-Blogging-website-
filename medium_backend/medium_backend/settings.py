...
SECRET_KEY = "django-insecure-ony=zc7t=q3p0s#1bou$7fr9j=w49-4iea)de@2=b_l68s-)86"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_RENDERER_CLASSES": (
        ...
        # 'rest_framework.renderers.BrowsableAPIRenderer',  # remove or comment this if not needed
    ),
}
